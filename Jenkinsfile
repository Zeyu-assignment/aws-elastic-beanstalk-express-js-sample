    ...
    stages {
        stage('Npm install') {
            steps {
                ...
                sh "echo 'Npm install starting......' | tee /var/jenkins_home/jobs/${env.JOB_NAME}/${BUILD_NUMBER}/logs/npm_install_${BUILD_NUMBER}.log"
        ...
        stage('Unit tests') {
            steps {
                sh "echo 'Unit tests starting......' | tee /var/jenkins_home/jobs/${env.JOB_NAME}/${BUILD_NUMBER}/logs/unit_tests_${BUILD_NUMBER}.log"
        ...
        stage('Docker Build') {
		    ...
		    sh "echo 'Build image starting......' |tee ${buildLog}"
        ...
        stage('Docker Push') {
		    ...
		    sh "echo 'Push image starting......' |tee ${pushLog}"
